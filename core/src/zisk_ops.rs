...
define_ops! {
    ...
    (Add, "add", Binary, 77, 0x0c, opc_add, op_add),
    (AddW, "add_w", Binary, 77, 0x2c, opc_add_w, op_add_w),
    (Sub, "sub", Binary, 77, 0x0d, opc_sub, op_sub),
    (SubW, "sub_w", Binary, 77, 0x2d, opc_sub_w, op_sub_w),
    ...
    (Eq, "eq", Binary, 77, 0x0b, opc_eq, op_eq),
    (EqW, "eq_w", Binary, 77, 0x2b, opc_eq_w, op_eq_w),
    ...
    (Leu, "leu", Binary, 77, 0x0e, opc_leu, op_leu),
    (Le, "le", Binary, 77, 0x0f, opc_le, op_le),
    (LeuW, "leu_w", Binary, 77, 0x2e, opc_leu_w, op_leu_w),
    (LeW, "le_w", Binary, 77, 0x2f, opc_le_w, op_le_w),
    (And, "and", Binary, 77, 0x10, opc_and, op_and),
    (Or, "or", Binary, 77, 0x11, opc_or, op_or),
    (Xor, "xor", Binary, 77, 0x12, opc_xor, op_xor),
